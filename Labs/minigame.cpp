...
double battle(Player hero,Enemy unit) //Функция отвечает за бой Enemy и Player
{
...
void bonus(Player player)  //Функция бонуса игроку за победу
{
    int a = 100 + rand() % 200;
    int b = 81 + rand() % 200;
    int rez=0;
